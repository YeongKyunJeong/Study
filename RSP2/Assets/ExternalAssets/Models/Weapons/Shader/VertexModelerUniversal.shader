...
Shader "VertexModelerUniversal"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[Gamma][SingleLineTexture]_Texture0("Texture 0", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				half2 texCoord14 = IN.ase_texcoord8.xy * float2( 1,1 ) + float2( 0,0 );
				half4 tex2DNode15 = tex2D( _Texture0, texCoord14 );
				half4 temp_cast_0 = (_Gamma).xxxx;
				

				float3 BaseColor = pow( tex2DNode15 , temp_cast_0 ).rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half2 texCoord14 = IN.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				half4 tex2DNode15 = tex2D( _Texture0, texCoord14 );
				half4 temp_cast_0 = (_Gamma).xxxx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half2 texCoord14 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				half4 tex2DNode15 = tex2D( _Texture0, texCoord14 );
				half4 temp_cast_0 = (_Gamma).xxxx;
...
/*ASEBEGIN
Version=19602
Node;AmplifyShaderEditor.PowerNode;11;-432,0;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;2.2;False;1;COLOR;0
Node;AmplifyShaderEditor.TexturePropertyNode;10;-1184,0;Inherit;True;Property;_Texture0;Texture 0;0;2;[Gamma];[SingleLineTexture];Create;True;0;0;0;False;0;False;2f441154066ad6b4eb0887cdb3b4ab52;2f441154066ad6b4eb0887cdb3b4ab52;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;14;-1184,208;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;12;-768,208;Half;False;Property;_Gamma;Gamma;1;0;Create;True;0;0;0;False;0;False;1;1;1;2.2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-768,288;Half;False;Property;_Smoothness;Smoothness;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;15;-768,0;Inherit;True;Property;_TextureSample0;Texture Sample 0;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.LinearToGammaNode;17;-576,-112;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=F0A7B7DAADD177F0F52355FE5E959100ADF55F06