...
namespace RSP
{
    ...
    {
        [field: SerializeField] [field: Range(0, 360f)] public float MinimumAngle { get; private set; }
        [field: SerializeField] [field: Range(0, 360f)] public float MaximumAngle { get; private set; }
