...
namespace RSP
{
    ...
    public class CapsuleColliderUtility
    {
        ...
        public void CalculateCapsulColliderDemensions()
        {
        ...
        {
            float colliderHeightDifference = DefaultColliderData.Height - CapsuleColliderData.Collider.height; // Why refer collider height again?\
